...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<ion-header [translucent]=\"true\">\n  <ion-toolbar>\n    <ion-title>\n      ¿Qué años tienes, oh?\n    </ion-title>\n  </ion-toolbar>\n</ion-header>\n\n<ion-content [fullscreen]=\"true\">\n  <ion-grid>\n    <ion-row>\n      <ion-col size=\"12\" size-md=\"6\" offset-md=\"3\">\n        <div class=\"ion-text-center\">\n          <h2>Hoy es {{ fechaHoyTexto }}</h2>\n        </div>\n      </ion-col>\n    </ion-row>\n    <ion-row>\n      <ion-col size=\"12\" size-md=\"6\" offset-md=\"3\">\n        <ion-item>\n          <ion-label><ion-icon slot=\"start\" name=\"calendar\"></ion-icon> ¿Cuando naciste? </ion-label>\n          <ion-datetime display-format=\"DD.MM.YYYY\"[(ngModel)]=\"fechaElegida\"></ion-datetime>\n        </ion-item>\n      </ion-col>\n    </ion-row>\n    <ion-row>\n      <ion-col size=\"12\" size-md=\"6\" offset-md=\"3\">\n        <ion-button size=\"large\" class=\"ion-margin\" (click)=\"calculaFecha()\" expand=\"block\" color=\"warning\">\n          Calcular\n        </ion-button>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n</ion-content>\n");
...
let HomePage = class HomePage {
    constructor(alertCtrl) {
        ...
        this.fechaElegida = new Date().toISOString();
    }
    ngOnInit() {
        this.fechaHoy = new Date();
        this.fechaHoyTexto = this.fechaHoy.toLocaleDateString();
    }
    calculaFecha() {
        const hoy = moment__WEBPACK_IMPORTED_MODULE_5__();
        const fechaCalculo = moment__WEBPACK_IMPORTED_MODULE_5__(this.fechaElegida);
        this.alertCtrl.create({
            header: 'Según mis calculos...',
            message: 'Tienes ' + hoy.diff(fechaCalculo, 'years') + ' años',
            buttons: ['Cerrar']
        }).then(alertEl => {
            alertEl.present();
        });
